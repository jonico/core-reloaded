...
/**
 * This is the base class for all TeamForge/ScrumWorks Pro Integration tests. It
 * will provide the basic functionality to login into TF/SWP, create and
 * retrieve artifacts. It can be configured using a file called tfswp.properties
 * 
 * @author jnicolai
 * 
 */
public class TFSWPIntegrationTest {
    ...
    /**
     * Logs into TF and SWP The needed properties are taken from
     * tfswp.properties Creates the TeamForge and ScrumWorks tester. Clears
     * backlog items and tasks within TeamForge and ScrumWorks.
     * 
    ...
    public void setUp() throws Exception {
        ...
        setCcfRetryInterval(Integer.parseInt(prop
    ...
    /**
     * Delete all artifacts within the TeamForge and ScrumWorks project/product,

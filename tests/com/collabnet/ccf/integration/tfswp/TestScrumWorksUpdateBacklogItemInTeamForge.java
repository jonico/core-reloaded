...
public class TestScrumWorksUpdateBacklogItemInTeamForge extends TFSWPIntegrationTest {
    ...
    public void updateBacklogItemInScrumWorks() throws Exception {
        ...
        GregorianCalendar doneDate = new GregorianCalendar(
                today.get(Calendar.YEAR), today.get(Calendar.MONTH),
                today.get(Calendar.DAY_OF_MONTH));
        backlogItem.setCompletedDate(doneDate.getTime());
        backlogItem.setThemes(getSWPTester()
                .transformToThemeWSO(theme1, theme2));
        ...
        assertEquals(Integer.valueOf(effort),
                (Integer) teamForgePbi.getPoints());

        final String artifactId = teamForgePbi.getId();
        assertEquals(
                Arrays.asList(benefit, penalty, scrumWorksPbiFromUpdate
                        .getKey(), SWPMetaData
                        ...
                        sprint.getEndDate(), theme1, theme2),

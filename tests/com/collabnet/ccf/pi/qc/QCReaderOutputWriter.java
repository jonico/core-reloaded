...
public class QCReaderOutputWriter extends QCConnectHelper implements IDataProcessor {
    ...
    public Document changeForQCWriter(Document incomingObj) {
        ...
        try {
            changedArtifact = GenericArtifactHelper
                    .createGenericArtifactJavaObject((Document) incomingObj);
        } catch (Exception e) {
        ...
        List<GenericArtifactField> allFields = changedArtifact
        ...
        for (int cnt = 0; cnt < allFields.size(); cnt++) {
             ...
             * thisField.setFieldValue
             * ("Artifact "+intBugId+":"+thisField.getFieldValue());
        ...
        try {
            changedDoc = GenericArtifactHelper
                    .createGenericArtifactXMLDocument(changedArtifact);
        } catch (Exception e) {
            System.out.println("GenericArtifact Parsing exception" + e);
        }

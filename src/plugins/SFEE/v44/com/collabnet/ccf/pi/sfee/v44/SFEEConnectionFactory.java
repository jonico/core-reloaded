 ...
 * com.collabnet.ccf.core.eis.connection.ConnectionFactory that will be used by
 * the ConnectionManager to create, close and check if the connection is live
 * and the session id is not invalid.
 * 
...
public class SFEEConnectionFactory implements ConnectionFactory<Connection> {
    ...
    private static final Log   log             = LogFactory
                                                       .getLog(SFEEConnectionFactory.class);
    ...
    public Connection createConnection(String systemId, String systemKind,
        ...
        if (connectionManager.isUseStandardTimeoutHandlingCode()) {
            ...
            sfSoap = new SourceForgeSOAPTimeoutWrapper(connectionInfo,
                    connectionManager);
        }
    ...
    /**
     * Checks if the session id associated with this connection obejct is valid.
     * 
     ...
     */
    private String login(ISourceForgeSoap sfSoap, String username,

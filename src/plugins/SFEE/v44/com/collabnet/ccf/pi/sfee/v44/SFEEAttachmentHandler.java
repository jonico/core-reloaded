...
public class SFEEAttachmentHandler {
            ...
            try {
                ...
                if (StringUtils.isEmpty(attachmentDataFileName)) {
                    ...
                    try {
                        ...
                        fileDescriptor = fileStorageSoapApp.uploadFile(
                                sessionId, dataHandler);
                    } catch (IOException e) {
                    ...
                    try {
                        ...
                        logConflictResolutor
                                .warn("Stale attachment update, trying again ...:",
                                        e);
                        soapDo = mTrackerApp.getArtifactData(sessionId,
                                artifactId);
                        fileAttached = true;
                    }
                }
    ...
    public List<GenericArtifact> listAttachments(String sessionId,
            ...
            List<String> artifactIds, ISourceForgeSoap sourceForgeSoap,
        ...
        for (String artifactId : artifactIds) {
            ...
            for (AttachmentSoapRow row : attachmentRows) {
                ...
                if (createdDate.after(lastModifiedDate)) {
                    ...
                    attachmentData = this.getAttachmentData(sessionId,
                            row.getRawFileId(),
    ...
    // /**
    // * This method retrieves all the attachments for all the artifacts present
    // * in the artifactRows Set and encoded them into GenericArtifact
    // attachment
    // * format.
    // *
    // * @param sessionId

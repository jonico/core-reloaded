...
public class SFEEToGenericArtifactConverter {
     ...
     */
    public GenericArtifact convert(ArtifactSoapDO dataObject,
        ...
        if (null != dataObject) {
            ...
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.actualHours, actualHours,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            String assignedTo = artifactRow.getAssignedTo();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.assignedTo, assignedTo,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            String category = artifactRow.getCategory();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.category, category,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            Date closeDate = artifactRow.getCloseDate();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.closeDate, closeDate,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            String customer = artifactRow.getCustomer();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.customer, customer,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            String description = artifactRow.getDescription();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.description, description,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            int estimatedHours = artifactRow.getEstimatedHours();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.estimatedHours, estimatedHours,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            ...
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.priority, priority,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            ...
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.statusClass, statusClass,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            String folderId = artifactRow.getFolderId();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.folderId, folderId,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            ...
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.createdBy, createdBy,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            Date createdDate = artifactRow.getCreatedDate();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.createdDate, createdDate,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            ...
            this.createGenericArtifactField(ArtifactMetaData.SFEEFields.id, id,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            genericArtifact.setSourceArtifactId(id);
            String lastModifiedBy = artifactRow.getLastModifiedBy();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.lastModifiedBy, lastModifiedBy,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            Date lastModifiedDate = artifactRow.getLastModifiedDate();
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.lastModifiedDate,
            ...
            this.createGenericArtifactField(
                    ArtifactMetaData.SFEEFields.version, version,
                    genericArtifact, fieldsMap, includeFieldMetaData);
            ...
            for (int i = 0; i < flexFieldNames.length; i++) {
                ...
                GenericArtifactField.FieldValueTypeValue fieldValueType = ArtifactMetaData
                ...
                if (flexFieldTypes[i]
                    ...
                    ArtifactMetaData.setDateFieldValue(flexFieldNames[i],
                            flexFieldValues[i], sourceSystemTimezone, field);
                } else {
                    field.setFieldValue(flexFieldValues[i]);
                }
                if (includeFieldMetaData) {
                    TrackerFieldSoapDO fieldDO = SFEEAppHandler
                    ...
                    if (flexFieldTypes[i]
                        ...
                        TrackerFieldValueSoapDO[] fieldValues = fieldDO
                                .getFieldValues();
    ...
    private GenericArtifactField createGenericArtifactField(
            ArtifactMetaData.SFEEFields sfField, Object value,

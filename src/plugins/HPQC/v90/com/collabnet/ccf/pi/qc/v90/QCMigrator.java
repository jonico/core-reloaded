...
public class QCMigrator extends QCWriter {
    ...
    public Document updateArtifact(Document gaDocument) {
        ...
        try {
            ...
            this.updateDefect(connection, targetArtifactId, genericArtifact,
                    allFields);
        } catch (Exception e) {
    ...
    protected Object[] processXMLDocument(Document gaDocument) {
        ...
        if (null != result && 1 == result.length) {
            ...
            outDoc.setTargetArtifactLastModifiedDate(inDoc
            ...
            outDoc.setSourceArtifactLastModifiedDate(inDoc
            ...
            try {
                returnDoc2 = GenericArtifactHelper
                        .createGenericArtifactXMLDocument(outDoc);
    ...
    protected void updateDefect(IConnection connection,
        ...
        //				connection, targetArtifactId, allFields, this
        //						.getUserName(), targetSystemTimezone);
        log.info("QC Defect " + targetArtifactId
                + " is migrated successfully with the changes from "

...
public class JIRAReader extends AbstractReader<JIRAConnection> {
    ...
    public GenericArtifact getArtifactData(Document syncInfo, String artifactId) {
        ...
        JIRAConnection connection;
        JIRAMetaData.extractUnusedFirstPartFromRepositoryId(sourceRepositoryId);
        try {
            connection = connect(sourceSystemId, sourceSystemKind,
                    sourceRepositoryId, sourceRepositoryKind, serverUrl,
                    getUserName() + JIRAConnectionFactory.PARAM_DELIMITER
        ...
        try {
            ...
            if (tfsType.equals(JIRAType.ISSUE)) {
                String projectKey = JIRAMetaData
                        .extractProjectKeyFromRepositoryId(sourceRepositoryId);
                String issueType = JIRAMetaData
                        .extractIssueTypeFromRepositoryId(sourceRepositoryId);
                jiraHandler.getIssue(connection, projectKey, issueType,
                        lastModifiedDate, lastSynchronizedVersion,
                        lastSynchedArtifactId, artifactId, getUserName(),
        ...
        try {
            if (jiraType.equals(JIRAType.ISSUE)) {
                ...
                String issueType = JIRAMetaData
                        .extractIssueTypeFromRepositoryId(sourceRepositoryId);
                //FIXME 
                jiraHandler.getChangedWorkItems(connection, projectName,
                        issueType, lastModifiedDate, lastSynchronizedVersion,
                        lastSynchedArtifactId, artifactStates, getUserName(),

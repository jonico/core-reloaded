...
public class CollabNetConnectionFactory implements ConnectionFactory<TrackerWebServicesClient> {
    private static final Log   log             = LogFactory
                                                       .getLog(CollabNetConnectionFactory.class);
    ...
    public void closeConnection(TrackerWebServicesClient connection)
            throws ConnectionException {
        //Nothing to do
    }

    public TrackerWebServicesClient createConnection(String systemId,
        ...
        if (null != credentialInfo) {
            ...
            if (null != splitCredentials) {
                if (1 == splitCredentials.length) {
                    ...
                    String message = "Credentials info is not valid "
                            + credentialInfo;
                    log.error(message);

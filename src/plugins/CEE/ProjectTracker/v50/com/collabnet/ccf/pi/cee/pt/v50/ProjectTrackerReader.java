...
public class ProjectTrackerReader extends AbstractReader<TrackerWebServicesClient> implements IDataProcessor {
    ...
    public static final String                                               CREATED_ON_FIELD_NAME                    = "{"
                                                                                                                              + TRACKER_NAMESPACE
                                                                                                                              + "}"
                                                                                                                              + CREATED_ON_FIELD;
    public static final String                                               MODIFIED_ON_FIELD_NAME                   = "{"
                                                                                                                              + TRACKER_NAMESPACE
                                                                                                                              + "}"
                                                                                                                              + MODIFIED_ON_FIELD;
    public static final String                                               REASON_FIELD_NAME                        = "{"
                                                                                                                              + TRACKER_NAMESPACE
                                                                                                                              + "}"
                                                                                                                              + REASON_FIELD;
    public static final String                                               ID_FIELD_NAME                            = "{"
                                                                                                                              ...
                                                                                                                              + "}"
                                                                                                                              + ID_FIELD;
    public static final String                                               CREATED_BY_FIELD_NAME                    = "{"
                                                                                                                              + TRACKER_NAMESPACE
                                                                                                                              + "}"
                                                                                                                              + CREATED_BY_FIELD;
    ...
    public List<GenericArtifact> getArtifactAttachments(Document syncInfo,
        ...
        ata[0] = new ArtifactType(trackerArtifactType.getTagName(),
                trackerArtifactType.getNamespace(),
        ...
        try {
            ...
            if (null != historyList) {
                for (History history : historyList) {
                    ...
                    int transactionsCount = transactions == null ? 0
                            : transactions.length;
                            ...
                            for (HistoryActivity ha : haa) {
                                ...
                                if (historyArtifactId
                                    ...
                                    if (ha.getTagName().equals(
                                            ATTACHMENT_TAG_NAME)) {
                                        if (ha.getType()
                                                .equals(ATTACHMENT_ADDED_HISTORY_ACTIVITY_TYPE)) {
                                            ...
                                            for (String attachmentId : attachmentIds) {
                                                ...
                                                if (StringUtils
                                                    ...
                                                    attachmentName = "PT-Attachment"
                                                            + attachmentId
                                                            + ".file";
                                                    log.warn("Could not determine attachment name for attachment id "
                                                            + attachmentId);
                                                }
                                                ...
                                                .getType()
                                                .equals(ATTACHMENT_DELETED_HISTORY_ACTIVITY_TYPE)) {
                                            String[] attachmentIds = ha
                                                    .getOldValue();
                                            for (String attachmentId : attachmentIds) {
                                                if (null == attachmentId)
                                                ...
                                                .getType()
                                                .equals(URL_ADDED_HISTORY_ACTIVITY_TYPE)) {
                                            String[] attachmentIds = ha
                                                    .getNewValue();
                                            for (String attachmentId : attachmentIds) {
                                                ...
                                                .getType()
                                                .equals(URL_DELETED_HISTORY_ACTIVITY_TYPE)) {
                                            String[] attachmentIds = ha
                                                    .getOldValue();
                                            for (String attachmentId : attachmentIds) {
                                                if (null == attachmentId)
        ...
        try {
                            ...
                            if (trackerAttribute.getAttributeType().equals(
                                ...
                                ArtifactTypeMetadata metadata = metadataHelper
                                        .getArtifactTypeMetadata(
                                                this.getRepositoryKey(syncInfo),
            ...
            for (ClientArtifactComment comment : comments) {
                ...
                // here, commentor is always lower case, so ignore case.
                        ...
                        && (!commentor.equalsIgnoreCase(this
                                ...
                                if (null != historyActivity) {
                                    ...
                                    if (lastModifiedDate.after(modifiedOnDate)) {
                                        log.warn("lastModified from synchronization status table ("
                                                + lastModifiedDate
                                                + ") is after last modified date of artifact "
                                                + historyArtifactId
                                                + " ("
                                                + modifiedOnDate + ").");
                                    }

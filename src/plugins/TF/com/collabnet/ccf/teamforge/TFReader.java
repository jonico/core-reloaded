...
public class TFReader extends AbstractReader<Connection> {
    ...
    public List<GenericArtifact> getArtifactAttachments(Document syncInfo,
        ...
        if (!TFConnectionFactory.isTrackerRepository(sourceRepositoryId)) {
            ...
            log.debug("Planning folders do not support attachments: "
                    + sourceRepositoryId);
            ...
            if (TFConnectionFactory.isTrackerRepository(sourceRepositoryId)) {
                    ...
                    if (0 == parents.length) {
                        ...
                        if (connection.supports53()) {
                            ...
                            if (null == planningFolderId) {
                                ...
                                genericArtifact
                                        .setDepParentSourceArtifactId(planningFolderId);
                ...
                if (!isIgnore && isRetrieveParentInfoForPlanningFolders()) {
                    ...
                    if (planningFolder.getParentFolderId().startsWith(
                        ...
                        genericArtifact
                                .setDepParentSourceArtifactId(planningFolder
                                        .getParentFolderId());
                    }
                }

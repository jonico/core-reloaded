...
/**
 * This entity service implementation is designed to work with CCF 2.x only
 * 
 ...
 * 
 */
public class EntityService2 extends LifecycleComponent implements IDataProcessor {
    /**
    ...
    private Object[] processXMLDocument(Document data) {
        ...
        try {
            ...
            String repositoryMappingDirectionId = XPathUtils.getAttributeValue(
            ...
            Object[] results = lookupTargetArtifact(element, sourceArtifactId,
                    sourceSystemId, sourceRepositoryId, targetSystemId,
                    targetRepositoryId, artifactType, repositoryMappingId);
     ...
     * @return true if project mapping exists, false if not
     */
    ...
    private boolean skipQuarantinedArtifact(Element element,
        ...
        inputParameters.add(repositoryMappingDirectionId);
        inputParameters.add(sourceArtifactId);
        inputParameters.add(artifactType);

...
public class CCFRuntimeException extends RuntimeException {
    ...
    /**
     * Constructs a CCFRuntimeException with the cause provided.
     * 
     * @param cause
    ...
    /**
     * Constructs a CCFRuntimeException with the cause providedand root cause
     * exception.
     * 
     * @param cause
     *            - A description of the exceptional condition
     * @param exception
     *            - The root cause exception that should be sent to the hospital
     */

 ...
 * 
 * Copyright notice * * Copyright (c) 2005 Feed'n Read Development Team *
 ...
 * </p>
 * 
 * @author <a href="mailto:smachhau@users.sourceforge.net">Sebastian
 *         Machhausen</a>
 */
public class StringUtils implements FormatterProxy {
    ...
    /**
     * <p>
     * The longest an entity can be {@value #LONGEST_ENTITY}, including the lead
     * & and trail ;
     * </p>
     * 
     * @see #SHORTEST_ENTITY
    ...
    static {
        ...
        for (int i = 0; i < entityKeys.length; i++) {
            ENTITY_MAPPING.put(entityKeys[i],
                    Character.valueOf(entityValues[i]));
            CHAR_ENTITY_MAPPING.put(Character.valueOf(entityValues[i]),
                    entityKeys[i]);
        }
     ...
     * 
     * @param text
     *            raw text to be processed; must not be <code>null</code>
     * 
     * @return converted text; HTML 4.0 entities such as &hearts; &#123; and
     *         &x#123; &nbsp; -> 16 are also handled; <code>null</code> input
     ...
     * 
     * @param text
     *            the HTML input <code>String</code> to convert; a
     *            <code>null</code> value is converted to an empty
     *            <code>String</code>
    ...
    /**
     * <p>
     * Converts the specified <code>entity</code> to a single <code>char</code>.
     * </p>
     * 
     * @param entity
     *            the entity to convert; it must have lead &amp; and trail ;
     *            stripped; may be a x#123 or #123 style entity; works faster if
     *            the entity is specified in lower case
     * 
     ...
     * <code>String</code> object. If the specified value is non null the value
     * is just being trimmed using {@link java.lang.String#trim}
     * </p>
     * 
     * @param str
     ...
     * 
     * @param text
     *            the raw text to strip HTML tags from
     * 
     * @return the text with all HTML tags stripped of; if <code>null</code> is
     ...
     * 
     * @param text
     *            the raw text to strip Underscore tags from
     * 
     * @return the text with all Underscore tags stripped of; if
    ...
    private static boolean hasNameAndDomain(String aEmailAddress) {
        ...
        return tokens.length == 2 && (!StringUtils.isEmpty(tokens[0]))
     ...
     * 
     * @param entity
     *            <code>String</code> that may hold an entity; lead & must be
